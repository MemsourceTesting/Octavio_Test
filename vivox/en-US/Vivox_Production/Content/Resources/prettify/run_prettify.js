...
(function () {
  ...
  var preObjects = document.getElementsByClassName("prettyprint");
 
  //checks if there are code blocks on screen, if there are it will run the script if not it wont		
...
var beginningURL = URLStr.split('Default.htm');
skinUrls.push(beginningURL[0] + 'Resources/prettify/prettify.css');
